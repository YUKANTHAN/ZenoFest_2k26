...
const stationsData = [
  {
    ...
    subtitle: 'The Race Begins — Register, Team Up & Get Set to Hack!',
    description: 'Portal opens for national teams to register. Form your squads and get ready for ZenoFest 2K26.',
  ...
  },
  {
    ...
    subtitle: 'Time to Spark Ideas — Let the Innovation Flow!',
    description: 'Submit your project synopsis, problem statements, and initial architecture diagrams.',
    color: '#ff65a3' // Pink
  },
  {
    id: 3,
    ...
    subtitle: 'Last Call to Enter the Arena — Register Before It\'s Too Late!',
    description: 'Final deadline to complete team registration and unlock project submission access.',
  ...
  },
  {
    ...
    subtitle: 'Ideas Lock In — Let the Best Concepts Win!',
    description: 'Final submission freeze for project slides, hardware lists, and problem statement writeups.',
  ...
  },
  {
    ...
    subtitle: 'The Shortlisted Teams for ZenoFest 2K26 Have Been Announced!',
    description: 'Expert panel evaluates submissions and publishes shortlisted projects moving to the final expo.',
  ...
  },
  {
    ...
    subtitle: 'Code. Create. Conquer — The 36-Hour Sprint Begins!',
    description: 'Live hackathon sprint commences on campus with mentor guidance and round-the-clock coding.',
  ...
  },
  {
    ...
    subtitle: 'Time\'s Up — Submit Your Best Work and Let It Shine!',
    description: 'Project code lock, hardware demo setup, and submission of final pitch slide decks.',
  ...
  },
  {
    ...
    dateLabel: 'SEP 19',
    title: 'Final Results',
    subtitle: 'The Moment of Truth — Winners Announced!',
    description: 'Grand auditorium valedictory, awarding ₹1,00,000+ cash prize pool, trophies, and certificates.',
    color: '#b388ff' // Bright Purple
  }
]
