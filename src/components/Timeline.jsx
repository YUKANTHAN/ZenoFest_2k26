...
export default function Timeline() {
  ...
  return (
    <div className="timeline-scroll-wrapper" ref={scrollWrapperRef} id="timeline">
      {/* ── MOBILE TIMELINE (DEVHACK SCROLL TRACKER) ── */}
      {isMobile ? (
        <section className="mobile-devhack-timeline-section">
          <div className="mobile-timeline-header">
            <h2 className="timeline-main-title">TIMELINE</h2>
          </div>

          <div className="mobile-timeline-tree">
            {/* Central Vertical Track Line */}
            <div className="mobile-central-line">
              <div className="mobile-line-pulse" />
            </div>
            ...
            {stationsData.map((station, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`mobile-timeline-item ${isReached ? 'reached' : ''} ${isCurrent ? 'active-item' : ''}`}
                ...
                >
                  <div className="mobile-node-circle" style={{ borderColor: station.color }}>
                    <div className="mobile-node-dot" style={{ backgroundColor: isReached ? station.color : 'transparent' }} />
                  </div>

                  <div className="mobile-timeline-card" style={{ '--card-accent': station.color }}>
                    <div className="card-window-header" style={{ backgroundColor: station.color }}>
                      <span className="platform-tag">{station.platform}</span>
                      <span className="mobile-time-tag">{station.subtitle}</span>
                    </div>
                    ...
                    <div className="card-body">
                      ...
                      <p className="card-subtitle-text">{station.description}</p>
                    </div>
                  </div>
                </motion.div>
              )
        ...
        /* ── DESKTOP PC TIMELINE (ORIGINAL TRAIN TRACK) ── */
