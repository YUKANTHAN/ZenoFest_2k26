  ...
  return (
    <section className="hero-section">
      ...
      <div className="hero-bottom-bar">
        ...
        <a
          href="https://forms.gle/XYEew2puseRppp448"
          target="_blank"
          rel="noopener noreferrer"
          className="hero-register-btn"
        >
          <span>Register Now</span>
          <svg className="btn-arrow-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M7 17L17 7" />
            <path d="M7 7h10v10" />
          </svg>
        </a>
