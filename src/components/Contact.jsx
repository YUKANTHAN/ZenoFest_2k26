...
import ContactEarth from './3d/ContactEarth'
import './Contact.css'
    ...
    <div id="contact">
      <section className="contact-section">
        ...
        <div className="contact-container">
          ...
          {/* Coordinators Card (single centered panel) */}
          <motion.div
      ...
      {/* Full-Screen Earth → Campus zoom-on-scroll experience */}
      <ContactEarth />

      {/* Bottom Divider & Footer Credits */}
      <section className="contact-footer-wrap">
        <div className="contact-container">
